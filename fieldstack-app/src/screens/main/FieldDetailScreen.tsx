...
/**
 * Placeholder until F5.3 lands. Receives the field id from navigation params
 * so we can verify the FieldAvailabilityCard → FieldDetail navigation works.
 */
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.surface, paddingTop: insets.top + spacing.lg }]}>
      ...
      <Text size="md" variant="secondary" style={{ marginTop: spacing.sm }}>
        Loading details for {route.params.fieldId}…
      </Text>
    </View>
  );
}
