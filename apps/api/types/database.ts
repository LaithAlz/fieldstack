  ...
  public: {
    Tables: {
      booking_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "booking_requests_field_id_fkey"
            columns: ["field_id"]
            isOneToOne: false
      ...
      user_booking_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_booking_history_field_id_fkey"
            columns: ["field_id"]
            isOneToOne: false
            referencedRelation: "fields"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_booking_history_venue_id_fkey"
            columns: ["venue_id"]
            isOneToOne: false
            referencedRelation: "venues"
            referencedColumns: ["id"]
      ...
      user_recently_viewed: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_recently_viewed_venue_id_fkey"
            columns: ["venue_id"]
            isOneToOne: false
            referencedRelation: "venues"
            referencedColumns: ["id"]
      ...
      user_saved_venues: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_saved_venues_venue_id_fkey"
            columns: ["venue_id"]
            isOneToOne: false
            referencedRelation: "venues"
            referencedColumns: ["id"]
      ...
      venues: {
        ...
        Relationships: [
          {
            foreignKeyName: "venues_duplicate_of_fkey"
